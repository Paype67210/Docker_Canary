...
#include <sstream>
#include "../scanner/BinariesScanner.hpp" // Ensure this header defines BinaryInfo
#include "../scanner/PackagesScanner.hpp" // Ensure this header defines PackageInfo
#include "../scanner/LargeFilesScanner.hpp" // Ensure this header defines LargeFileInfo
#include "../scanner/SecretsScanner.hpp" // Ensure this header defines SecretInfo
    ...
    const std::vector<LargeFileInfo>& largeFiles)
{
    ...
    for (const auto& s : secrets) {
        secretFindings.push_back(s.path + ":" + s.line + " => " + s.content);
    }
